...
// LAST COMMENTS
// 18) Candidate table
// - you shouldn’t be importing JSON files as scripts
// - there isn’t a way to stop editing a row without editing something else or deleting
...
function insertRows (id, name, lastName, phone, data, flag=0){
    ...
    let element, nameElement, child, index, targetNote;
    for (let i=0;i<3;i++){    
    ...
    element.addEventListener('click', function(event){
        ...
        nameElement=parent.children[index-3+0];
